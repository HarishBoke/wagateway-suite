    ...
    <div className="login-container">
      <div className="login-card">
        <div className="login-logo">
          <img src="/wagateway_logo.webp" alt="WA Gateway" className="logo-icon" />
        ...
        <p className="login-help">
          {t('login.help')}{' '}
          <a
            href="https://github.com/HarishBoke/wagateway-suite/blob/main/docs/01-project-overview.md"
            target="_blank"
      ...
      <footer className="login-footer">
        ...
        <a
          href="https://github.com/HarishBoke/wagateway-suite"
          target="_blank"
          rel="noopener noreferrer"
