...
<p align="center">
  <img src="../docs/logo/wagateway_logo.webp" alt="WA Gateway Logo" width="120"/>
</p>

Modern web dashboard for managing WA Gateway Messaging API Gateway sessions, webhooks, and infrastructure.
...
The dashboard connects to the WA Gateway API backend. Configure the API URL in environment variables:
...
MIT License - Part of the [WA Gateway](https://github.com/HarishBoke/wagateway-suite) project.
