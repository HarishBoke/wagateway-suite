...
WA Gateway supports multiple infrastructure configurations. Choose based on your needs:
...
DATABASE_URL=postgresql://wagateway:wagateway@localhost:5432/wagateway
...
docker run --shm-size=2gb wagateway
```
