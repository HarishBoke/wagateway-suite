...
>
> This document outlines the planned testing strategy for WA Gateway. The current implementation includes only foundational tests:
>
  ...
  integration-tests:
    ...
    steps:
      ...
      - run: npm run test:integration
        env:
          DATABASE_URL: postgresql://test:test@localhost:5432/wagateway_test
