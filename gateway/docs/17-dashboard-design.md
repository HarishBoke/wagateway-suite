...
The dashboard is a web-based management interface for WA Gateway that lets users manage sessions, webhooks, and monitor activity without using the API directly.
...
│  ┌───────────────────────────────────────────────────────────────┐  │
│  │  🔗 Main Webhook                                   ✅ Active   │  │
│  │  https://api.example.com/webhook/wagateway                        │  │
...
server {
    ...
    # API proxy (if needed)
    location /api {
        proxy_pass http://wagateway:2785;
