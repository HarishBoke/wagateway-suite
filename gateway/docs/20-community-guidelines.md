...
WA Gateway is committed to providing a welcoming and inclusive environment for everyone. We pledge to make participation in our project and community a harassment-free experience for all, regardless of:
...
# 2. Clone your fork
git clone https://github.com/YOUR_USERNAME/wagateway.git
cd wagateway

# 3. Add upstream remote
git remote add upstream https://github.com/HarishBoke/wagateway-suite.git
...
- **Q&A**: Questions about using WA Gateway
- **Ideas**: Feature suggestions and brainstorming
- **Show and Tell**: Share your projects using WA Gateway
...
Channels:
- `#general` - General discussion
- `#support` - Help with WA Gateway
- `#development` - Development discussions
- `#showcase` - Share your projects
- `#off-topic` - Non-WA Gateway discussions
...
Thanks to all the people who have contributed to WA Gateway!
...
Instead:
1. Email: security@wagateway.dev
