...
```mermaid
timeline
    title WA Gateway Release Timeline
...
├── Docker image (ghcr.io/HarishBoke/wagateway:0.0.1)
├── docker-compose.yml
...
├── Docker image (ghcr.io/HarishBoke/wagateway:0.0.2)
...
├── Docker image (ghcr.io/HarishBoke/wagateway:0.1.0)
