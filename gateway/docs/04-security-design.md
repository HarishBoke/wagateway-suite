...
```mermaid
sequenceDiagram
    participant OW as WA Gateway
    participant WH as Webhook Endpoint
    
    OW->>OW: Create payload
    OW->>OW: Sign with HMAC-SHA256
    OW->>WH: POST + X-WA Gateway-Signature
...
communication:
  ...
  status_page: "https://status.wagateway.dev"
```
