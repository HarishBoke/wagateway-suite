...
@dataclass
class WA GatewayClientConfig:
    """Configuration for the WA Gateway client."""
...
class WA GatewayClient:
    ...
    def _request(self, method: str, path: str, json: Any = None) -> Any:
        ...
        try:
            ...
            raise ImportError(
                "httpx is required for the WA Gateway SDK. "
                "Install it with: pip install wagateway-sdk"
            )
...
class _SessionsResource:
    def __init__(self, client: WA GatewayClient) -> None:
        self._client = client
