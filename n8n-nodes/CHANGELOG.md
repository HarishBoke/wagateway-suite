...
## [0.1.1](https://github.com/HarishBoke/wagateway-suite/compare/v0.1.0...v0.1.1) (2026-02-17)

### Security

* add webhook secret authentication for trigger node ([#1](https://github.com/HarishBoke/wagateway-suite/issues/1))
...
## [0.1.0](https://github.com/HarishBoke/wagateway-suite/releases/tag/v0.1.0) (2025-01-01)

### Features

* initial release with WA Gateway node and WA Gateway Trigger node
