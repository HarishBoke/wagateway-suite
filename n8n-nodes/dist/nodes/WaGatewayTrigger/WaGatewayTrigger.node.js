...
exports.WaGatewayTrigger = void 0;
...
class WaGatewayTrigger {
    constructor() {
        this.description = {
            ...
            description: 'Starts workflow when WA Gateway events occur',
            defaults: {
        ...
        this.webhookMethods = {
            default: {
                ...
                async create() {
                    ...
                    const response = await this.helpers.httpRequestWithAuthentication.call(this, 'waGatewayApi', {
                        method: 'POST',
...
exports.WaGatewayTrigger = WaGatewayTrigger;
//# sourceMappingURL=WaGatewayTrigger.node.js.map